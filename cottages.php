...
<div id="indicators-carousel" class="relative w-full" data-carousel="static">
    <div class="relative h-56 overflow-hidden rounded-base md:h-96">
        <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
            <img src="<?php echo e(frontend_asset('campuyo1.jpg')); ?>" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 object-cover" alt="Resort View 1">
        </div>
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="<?php echo e(frontend_asset('campuyo1.jpg')); ?>" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 object-cover opacity-80" alt="Resort View 2">
        </div>
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="<?php echo e(frontend_asset('campuyo1.jpg')); ?>" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 object-cover grayscale" alt="Resort View 3">
        </div>
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
