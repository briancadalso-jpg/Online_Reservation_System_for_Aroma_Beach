...
<footer class="bg-gray dark:bg-green-1000">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <img src="https://flowbite.com/docs/images/logo.svg" class="h-7 me-3" alt="FlowBite Logo" />
                  <span class="text-heading self-center text-2xl font-semibold whitespace-nowrap">Aroma Beach Resort</span>
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul class="text-body font-medium">
                      ...
                      <li>
                          <a href="#" onclick="my_modal_1.showModal()" class="hover:underline">Terms & Conditions</a>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-body sm:text-center">© 2026 <a href="https://flowbite.com/" class="hover:underline">Aroma Beach Resort™</a>. All Rights Reserved.
          </span>
