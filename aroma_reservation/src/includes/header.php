...
<body>
    ...
    <nav class="relative bg-green-800">
  <div class="mx-auto max-w-12xl px-30 sm:px-6 lg:px-12">
    <div class="relative flex h-16 items-center justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex shrink-0 items-center">
          <img src="../assets/aromaresortlogo.png" class="h-12 w-8" />
        </div>
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
            <a href="home.php" aria-current="page" class="rounded-md bg-green-900 px-3 py-2 text-2xl font-bold text-white">Aroma Beach Resort</a>
            <a href="home.php" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Home</a>
            <a href="cottages.php" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Cottages</a>
            <a href="reservations.php" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Reservations</a>
  ...
  <input type="search" class="grow" placeholder="Search" />
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        <button type="button" class="relative rounded-full p-1 text-gray-400 focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500">
          ...
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" data-slot="icon" aria-hidden="true" class="size-6">
